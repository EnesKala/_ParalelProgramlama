package com.example.paralelprogramlama;
import java.io.BufferedWriter;
import java.io.FileWriter;
import java.io.IOException;
import java.util.Scanner;

public class ParalelProgramlamaApplication extends Thread {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        ParalelProgramlamaApplication thread1 = new ParalelProgramlamaApplication();
        thread1.kullaniciBilgileriniDosyayaKaydet();

        // 2. Thread: Gizli bilgileri dosyaya kaydet
        ParalelProgramlamaApplication thread2 = new ParalelProgramlamaApplication();
